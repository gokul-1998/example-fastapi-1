...
def test_update_post(authorized_client,test_user,test_posts):
    data={"title":"updated title","content":"updated content1","id":test_posts[0].id}
...
def test_update_other_user_post(authorized_client,test_user,test_posts):
    data={"title":"updated title","content":"updated content1","id":test_posts[3].id}
...
def test_unauthorized_user_update_posts(client,test_posts,test_user):
    res=client.put(f"/posts/{test_posts[0].id}",json={"title":"title1","content":"content1"})
    assert res.status_code==401
